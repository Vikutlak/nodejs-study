...
// Process the check outcome, update the check data as needed, trigger and alert to the user if needed
// Special logic for accomodating a check that has never been teste before (don't want alert on that one)
workers.processCheckOutcome = (originalCheckData, checkOutcome) => {
...
// Alert the usar as to a change in their check status
workers.alertUserToStatusChange = (newCheckData) => {
